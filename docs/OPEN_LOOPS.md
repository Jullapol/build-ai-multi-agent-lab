...
| H1 | Hardening: rate limit + anti-spam ฝั่ง backend — D-03 (`src/lib/rate-limit.ts`, 429 + Retry-After, ยืนยัน live) | 2026-09-25 |
| H2 | Hardening: CSP/security headers + sanitize + honeypot — D-04/D-05 (prod verified: inline script 0, console 0 error, honeypot 201 ไม่เข้า DB) | 2026-09-25 |
